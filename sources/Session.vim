...
badd +53 mmanager.c
badd +14 Move.c
badd +13 ../headers/Engine.h
badd +96 ../headers/Config.h
badd +15 ../headers/Consts.h
badd +760 /usr/include/pthread.h
badd +39 ../headers/mmanager.h
badd +0 /MEMALLOC_DEBUG_LIST
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 117 - ((37 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 385 - ((27 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
385
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((5 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 798 - ((48 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
798
