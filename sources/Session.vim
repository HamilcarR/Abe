...
silent only
cd /home/hamilcar/Bureau/chess/Chess/gitrepo/sources
...
silent! normal! zE
let s:l = 106 - ((42 * winheight(0) + 32) / 65)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 121 - ((63 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 88 - ((58 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 962 - ((14 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
962
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((15 * winheight(0) + 32) / 65)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 292 - ((42 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
292
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 985 - ((33 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
985
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 144 - ((39 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
144
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((1 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
